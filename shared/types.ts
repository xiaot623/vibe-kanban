...
export type DraftFollowUpData = { message: string, variant: string | null, executor: BaseCodingAgent | null, };
...
export type CreateFollowUpAttempt = { prompt: string, variant: string | null, executor: BaseCodingAgent | null, retry_process_id: string | null, force_when_dirty: boolean | null, perform_git_reset: boolean | null, };
...
export enum EditorType { VS_CODE = "VS_CODE", CURSOR = "CURSOR", WINDSURF = "WINDSURF", INTELLI_J = "INTELLI_J", GO_LAND = "GO_LAND", ZED = "ZED", XCODE = "XCODE", GOOGLE_ANTIGRAVITY = "GOOGLE_ANTIGRAVITY", TRAE = "TRAE", CUSTOM = "CUSTOM" }
...
export type PowerMode = "SYSTEM_DEFAULT" | "KEEP_AWAKE" | "KEEP_SCREEN_ON";
...
export enum BaseCodingAgent { CLAUDE_CODE = "CLAUDE_CODE", GEMINI = "GEMINI", CODEX = "CODEX", OPENCODE = "OPENCODE", DROID = "DROID" }

export type CodingAgent = { "CLAUDE_CODE": ClaudeCode } | { "GEMINI": Gemini } | { "CODEX": Codex } | { "OPENCODE": Opencode } | { "DROID": Droid };
...
export type ExecutorConfig = { [key in string]?: { "CLAUDE_CODE": ClaudeCode } | { "GEMINI": Gemini } | { "CODEX": Codex } | { "OPENCODE": Opencode } | { "DROID": Droid } };
